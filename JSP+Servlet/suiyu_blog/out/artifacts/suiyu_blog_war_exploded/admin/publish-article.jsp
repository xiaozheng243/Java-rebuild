    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <h1>
                已发布文章
                <%
                    ArrayList<PostDemo> list = (ArrayList<PostDemo>) request.getAttribute("publishArticles");
                %>
                <small>共发布了<%=list.size()%>篇文章，还需努力呦(*^▽^*)！</small>
            </h1>
        </section>
                                        ...
                                        <td>
                                            <div class="btn-group" role="group" aria-label="...">
                                                <button type="button" class="btn btn-info"
                                                        onclick="change(<%=postDemo.getAid()%>,1)">编辑
                                                </button>
                                                ...
                                                <button type="button" class="btn btn-success"
                                                        onclick="change(<%=postDemo.getAid()%>,4)">转为草稿
                                                </button>
                                                <button type="button" class="btn btn-danger"
                                                        onclick="change(<%=postDemo.getAid()%>,3)">删除
                                                </button>
                                            </div>
                                        </td>
                                    </tr>
